    ...
    <div class="card mx-auto formContainer">
      ...
      <div class="card-body d-flex flex-column mx-auto px-0 justify-content-around w-50">
        ...
        <div>
          ...
          <input type="password" v-model="password" name="password" class="form-control formInput mx-auto" placeholder="••••••••••" required>
      ...
      <div class="mx-auto mt-2 small text-dark mb-5 formSubLabel">Créer un compte</div>
    </div>
  </form>
</template>
<script>
