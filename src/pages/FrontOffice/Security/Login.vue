  ...
  <div>
    ...
    <form method="post" @submit.prevent="onFormSubmit">
      <div class="card mx-auto loginFormContainer">
        ...
        <div
          class="card-body d-flex flex-column mx-auto px-0 justify-content-around w-50"
        >
          <div>
        ...
        <button class="btn w-50 mt-4 mx-auto formSubmit" type="submit">
          Se connecter
        </button>
        <router-link
          :to="{ name: 'register' }"
          class="mx-auto mt-2 small text-dark mb-5 formSubLabel"
          >Créer un compte
        </router-link>
      </div>
    </form>
