    ...
    <form>
      <table>
        <tbody>
          <tr>
            <td>
              <label>Titre</label>&nbsp;<span class="error" v-if="titleError"
                >Titre requis.</span
              ><br />
          ...
          <tr>
            <td>
              <label class="reward">Récompense</label>&nbsp;<span
                class="error"
                v-if="rewardError"
                >Récompense requise.</span
              >
              <label>Récompense exp</label>&nbsp;<span
                class="error"
                v-if="rewardExpError"
                >Récompense exp requise.</span
              >
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
              <label>Durée estimée</label>&nbsp;<span
                class="error"
                v-if="estimateDateError"
                >Date estimée requise..</span
              ><br />
              <input type="number" id="days" class="number" v-model="days" />
              jours
              <input type="number" id="hours" class="number" v-model="hours" />
              heures
            </td>
          </tr>
          <tr>
            <td>
              <label>Date limite</label>&nbsp;<span
                class="error"
                v-if="limitDateError"
                >Date limite requise.</span
              ><br />
          ...
          <tr>
            <td>
              ...
              />
              Nombre de personnes minimum &nbsp;<span
                class="error"
                v-if="numberPeopleError"
                >Nombre de personnes requis.</span
              ><br />
            </td>
            <td v-if="assistant">
              <label>Commanditaire</label>&nbsp;<span
                class="error"
                v-if="clientError"
                >Commanditaire requis.</span
              ><br />
              <input
                class="client"
                list="clients"
              ...
              />
              <datalist id="clients">
                <option v-for="client in clients" :data-id="client.id">
                  {{ client.name }}
                </option>
              </datalist>
            </td>
          ...
          <tr>
            <td>
              <label>Niveau minimum requis</label>&nbsp;<span
                class="error"
                v-if="levelError"
                >Niveau requis.</span
              ><br />
          ...
          <tr>
            <td>
              <label class="levellabel">Mêlée</label
              ><img alt="Vue logo" src="../../assets/img/sword.png" />
              <label class="levellabel">Archers</label
              ><img alt="Vue logo" src="../../assets/img/bow.png" />
              <label class="levellabel">Mages</label
              ><img alt="Vue logo" src="../../assets/img/wand.png" />
              <label class="levellabel">Artisans</label
              ><img alt="Vue logo" src="../../assets/img/hammer.png" />
            </td>
          </tr>
          <tr>
            <td>
  ...
  methods: {
    ...
    checkForm() {
      ...
      if (
        ...
        this.numberPeople &&
        this.client &&
        (this.melee || this.archer || this.mage || this.artisan)
      ) {
      ...
      if (
        ...
        const data = {
          ...
          recompense: this.reward,
          recompense_exp: this.rewardExp,
          duree: time,
          date_limite: this.date,
          nbr_personne_minimum: this.numberPeople,
